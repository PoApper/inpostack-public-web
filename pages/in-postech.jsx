...
const Open = () => {
  return <Label size="tiny" color="green"
                style={{ borderRadius: '15px', marginLeft: '5px' }}>Open</Label>
}

const Closed = () => {
  return <Label size="tiny" color="red" style={{
    borderRadius: '15px',
    marginLeft: '5px',
  }}>Closed</Label>
}
...
const HaksikTime = (hour, min) => {
  ...
  if (hour === 7 || hour === 11 || hour === 17) {
    ...
    if (min <= 30) { open = 1 }
  } else if (hour === 8 || hour === 12 || hour === 18) {
    open = 1
  }
    ...
    <Layout>
      ...
      <div style={{
        ...
        <Haksik>
          <div>
            ...
            <Button size="mini" style={{
              ...
              <a href="https://dining.postech.ac.kr/"
          ...
          <Image
            src={'/in-postech/spoon.svg'} alt={'spoon'}
            size="tiny" style={{ marginLeft: '80px' }}/>
        </Haksik>
        <GYD>
          <div>
            <Subject>
          ...
          <Image
            src={'/in-postech/dish.svg'} alt={'dish'}
        ...
        <Burgerking>
          ...
          <Image
            src={'/in-postech/burgerking.svg'} alt={'burgerking'}
            size="small" style={{ marginLeft: '160px' }}/>
        </Burgerking>
      </div>
      ...
      <div style={{
        ...
        <Matkki>
          ...
          <Image
            src={'/in-postech/masinneunkkini.png'} alt={'masinneunkkini'}
            size="small" style={{ marginLeft: '160px', marginTop: '20px' }}/>
        </Matkki>
        <GYD>
          <div>
            <Subject>
      ...
      <div style={{
        ...
        <BlueHill>
          ...
          <h4>영업시간: 11:00 - 13:30</h4>
          <Image
            src={'/in-postech/thebluehill.svg'} alt={'thebluehill'}
            size="small" style={{ marginLeft: '160px', marginTop: '8px' }}/>
        </BlueHill>
      </div>
    </Layout>
  )
